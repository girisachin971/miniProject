...
public class DataBaseCreater {
	...
	public static void createStudentTable() {
		try {
		String query = "create table student(ID int primary key auto_increment,First_Name varchar(255),Last_Name varchar(255),score int,AttemptDate date,grade varchar(255),Mobile_No long)";
		DataBaseCreater data = new DataBaseCreater();
		data.passQuery(query);
